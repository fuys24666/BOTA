...
& $Python -m src.bota_short_benchmark.runner --root $Root --config configs/bota_short_benchmark_v1.yaml --mode $Mode --method Original --benchmark-name $BenchmarkName --scenario $Scenario --run-name $RunName
